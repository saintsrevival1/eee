...
local Library do
    ...
    Library.Window = function(self, Data)
        ...
        local Window = { 
            Logo = Data.Logo or Data.logo or "72316209028225",
        ...
        local Items = Components:Window({
            ...
            -- Custom cursor only while the menu is open (SetOpen syncs this)
            UserInputService.MouseIconEnabled = true
        ...
        local function SyncCustomCursor(Bool)
            Items["MouseBackground"].Instance.Visible = Bool == true
        ...
        function Window:SetOpen(Bool)
            ...
            -- Cursor follows menu visibility immediately (not after the fade)
            SyncCustomCursor(Window.IsOpen)
        ...
        if IsMobile then
            ...
            Items["MobileToggleIcon"] = Instances:Create("ImageLabel", {
                Parent = Items["MobileToggle"].Instance,
                Name = "\0",
                AnchorPoint = Vector2New(0.5, 0.5),
                Position = UDim2New(0.5, 0, 0.5, 0),
                ...
                BackgroundTransparency = 1,
                BorderSizePixel = 0,
                Image = "rbxassetid://72316209028225",
                ScaleType = Enum.ScaleType.Fit,
                ZIndex = 10001,
            })
